...
export default function RecipeDetailsPage() {
  ...
  return (
    <div className="mx-auto grid max-w-full grid-cols-1 gap-6 p-6 md:grid-cols-12 lg:max-w-7xl">
      ...
      <div className="col-span-12">
        <div className="relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <h1 className="font-magtis bg-black bg-opacity-60 p-2 text-7xl text-white">
              {recipe.title}
            </h1>
          </div>
        </div>
      ...
      <div className="col-span-12 rounded-lg bg-offwhite p-6 shadow md:col-span-4">
      ...
      <div className="col-span-12 rounded-lg bg-offwhite p-6 shadow md:col-span-12">
        <h2 className="mb-4 text-2xl font-semibold">Nutritional Information</h2>
